...
SELECT CAST(event_data as XML) AS [DATA]
FROM sys.fn_xe_file_target_read_file ('LOGIN_APP_CONNECT*.xel', null, null, null)

SELECT CAST(event_data as XML) AS [DATA]
FROM sys.fn_xe_file_target_read_file ('QUERY_IO*.xel', null, null, null)

SELECT CAST(event_data as XML) AS [DATA]
FROM sys.fn_xe_file_target_read_file ('QUERY_CPU*.xel', null, null, null)
